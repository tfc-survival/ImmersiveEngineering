...
public abstract class ManualPages implements IManualPage {
    ...
    public static class Crafting extends ManualPages {
        ...
        public void recalculateCraftingRecipes() {
            ...
            Iterator<IRecipe> itRecipes = ForgeRegistries.RECIPES.getValuesCollection().iterator();
        ...
        void checkRecipe(IRecipe rec, Object key, Object stack, int iStack) {
            if (!rec.getRecipeOutput().isEmpty() && ManualUtils.stackMatchesObject(rec.getRecipeOutput(), stack)) {
                ...
                int w;
                int h;
                if (rec instanceof ShapelessRecipes || rec instanceof ShapelessOreRecipe || rec instanceof MCRecipeShapeless) {
                ...
                } else if (rec instanceof MCRecipeShaped) {
                    w = ((MCRecipeShaped) rec).getRecipeWidth();
                    h = ((MCRecipeShaped) rec).getRecipeHeight();
                } else
                    return;
