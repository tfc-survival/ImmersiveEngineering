            ...
            for (int w = -1; w <= 1; w++)
                for (int h = -1; h <= 1; h++) {
                    ...
                    if (curr instanceof TileEntityDieselGenerator) {
                        ...
                        tile.offset = new int[]{
                                side == EnumFacing.WEST ? -l + 2 : side == EnumFacing.EAST ? l - 2 : side == EnumFacing.NORTH ? ww : -ww,
                                h,
                                side == EnumFacing.NORTH ? -l + 2 : side == EnumFacing.SOUTH ? l - 2 : side == EnumFacing.EAST ? ww : -ww
                        };
