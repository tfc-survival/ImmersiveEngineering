            ...
            for (int w = -2; w <= 2; w++)
                for (int h = -1; h <= 1; h++) {
                    ...
                    if (curr instanceof TileEntityCrusher) {
                        ...
                        tile.offset = new int[]{
                                side == EnumFacing.WEST ? -l + 1 : side == EnumFacing.EAST ? l - 1 : side == EnumFacing.NORTH ? ww : -ww,
                                h,
                                side == EnumFacing.NORTH ? -l + 1 : side == EnumFacing.SOUTH ? l - 1 : side == EnumFacing.EAST ? ww : -ww
                        };
