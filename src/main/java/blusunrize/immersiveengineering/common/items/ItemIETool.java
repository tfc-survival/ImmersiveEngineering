...
public class ItemIETool extends ItemIEBase implements ITool, IGuiItem, IItemDamageableIE {
    ...
    public ItemStack getContainerItem(@Nonnull ItemStack stack) {
        if (stack.getMetadata() == HAMMER_META || stack.getMetadata() == CUTTER_META) {
            ...
            damageIETool(container, 1, Utils.RAND, null);
            return container;
        }
    ...
    public boolean onBlockStartBreak(ItemStack itemstack, BlockPos pos, EntityPlayer player) {
        if ((itemstack.getMetadata() == HAMMER_META || itemstack.getMetadata() == CUTTER_META) && player != null && !player.world.isRemote && !player.capabilities.isCreativeMode) {
            ...
            damageIETool(itemstack, effective ? 1 : 2, player.getRNG(), player);
        }
        return false;
    }
    ...
    public static boolean isRecipesIndexed = false;
    ...
    public Set<String> getToolClasses(ItemStack stack) {
        ...
        return meta == HAMMER_META ? ImmutableSet.of(Lib.TOOL_HAMMER) : meta == CUTTER_META ? ImmutableSet.of(Lib.TOOL_WIRECUTTER) : new HashSet<>();
    }
