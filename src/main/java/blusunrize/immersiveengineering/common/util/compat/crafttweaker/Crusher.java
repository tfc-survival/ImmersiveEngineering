...
public class Crusher {
    ...
    @ZenMethod
    public static void addRecipeWithMultipleSecondary(IItemStack output, IIngredient input, int energy, WeightedItemStack... secondaryOutput) {
        ...
        if (secondaryOutput != null)
            for (WeightedItemStack weightedItemStack : secondaryOutput)
                r.addToSecondaryOutput(CraftTweakerHelper.toStack(weightedItemStack.getStack()), weightedItemStack.getChance());
    ...
    public static void addRecipe(IItemStack output, IIngredient input, int energy, @Optional IItemStack secondaryOutput, @Optional double secondaryChance) {
        addRecipeWithMultipleSecondary(output, input, energy, new WeightedItemStack(secondaryOutput, (float) secondaryChance));
    }
