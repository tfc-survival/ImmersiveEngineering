...
//		sound.evaluateVolume();
        ...
        if (entity instanceof EntityPlayer) {
            ...
            for (EnumHand hand : EnumHand.values()) {
                ...
                if (!heldItem.isEmpty()) {
                    ...
                    if (heldItem.getItem() instanceof ItemDrill || heldItem.getItem() instanceof ItemChemthrower) {
                        if (right) {
     ...
     */
    public static void renderModelTESRFancy(List<BakedQuad> quads, BufferBuilder renderer, World world, BlockPos pos, boolean useCached) {//TODO include matrix transformations?, cache normals?
